...
urlpatterns = [
    ...
    path('book/<int:book_id>/bookmark/', views.bookmark_book, name='bookmark_book'),
    ...
    path('view_plant_3d/', views.view_plant_3d, name='view_plant_3d'),
    path('chat/', views.chatgpt_view, name='chatgpt_view'),
